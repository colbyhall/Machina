...
namespace Grizzly::Core {
	...
	public:
		...
		GRIZZLY_ALWAYS_INLINE f64 as_secs_f64() const { return (f64)m_secs + ((f64)m_nanos / (f64)nanos_per_sec); }
	...
	public:
		...
		GRIZZLY_ALWAYS_INLINE Duration elapsed() const { return Instant::now().since(*this); }
