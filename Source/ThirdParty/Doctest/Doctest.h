...
#ifdef DOCTEST_CONFIG_INCLUDE_TYPE_TRAITS
		template <typename Value>
		typename std::enable_if<std::is_constructible<double, Value>::value, Approx&>::type
		epsilon(const Value& newEpsilon) {
...
// =================================================================================================
		...
		struct ConsoleReporter : public IReporter {
			...
			void
			successOrFailColoredStringToStream(bool success, assertType::Enum at, const char* success_str = "SUCCESS") {
